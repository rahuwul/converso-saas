...
const formSchema = z.object({
  ...
  duration: z.number().min(2, { message: "Durations is required." }),
});
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Ex: Derivatives and Integrals, etc." {...field} />
              </FormControl>
